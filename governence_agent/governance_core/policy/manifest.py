...
# Ã¢â€â‚¬Ã¢â€â‚¬ Classification levels Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
TOOL_POLICIES: dict[str, ToolPolicy] = {
    "get_customer_orders": ToolPolicy(
        ...
        account_scoped=True,
        risk=READ_SENSITIVE,
        description="Lists a customer's orders Ã¢â‚¬â€ can filter by date, status, or minimum amount.",
        fields={
            "customerId": INTERNAL,
    ...
    "get_customer_profile": ToolPolicy(
        ...
        account_scoped=True,
        risk=READ_SENSITIVE,
        description="Shows a customer's billing profile Ã¢â‚¬â€ credit limit, payment terms, account type.",
        fields={
            "customerId": INTERNAL,
    ...
    "get_invoice_details": ToolPolicy(
        ...
        risk=READ_SENSITIVE,
        description="Looks up one invoice Ã¢â‚¬â€ amount, date, and what's still owed.",
        fields={
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ Secondary resolvers (entry points; not account-scoped -- they RESOLVE a
    #    customer_id, so they cannot require one). Homed on minierp_accounts so
    #    the accounts category (which grants PII) authorizes + redacts them. Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ Tertiary composites (360 views). Cross-domain, so they emit BOTH PII and
    ...
    #    on minierp_accounts so the accounts category (FULL level set) grants them. Ã¢â€â‚¬Ã¢â€â‚¬
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ Quaternary: aggregations + reverse lookups Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    "get_customer_order_summary": ToolPolicy(
        backend="minierp_orders",
        intent="customer_order_summary",
        account_scoped=True,
        risk=READ_SENSITIVE,
        description="Summarizes a customer's order history Ã¢â‚¬â€ counts, average order size, and spend over time.",
    ...
    "get_product_sales": ToolPolicy(
        ...
        account_scoped=False,
        risk=READ_SENSITIVE,
        description="Shows how well a product is selling Ã¢â‚¬â€ quantity sold and revenue.",
    ...
    "get_order_details": ToolPolicy(
        ...
        account_scoped=False,
        risk=READ_SENSITIVE,
        description="Looks up the basic details of one order Ã¢â‚¬â€ status, date, and total.",
        fields={
            "orderNumber": INTERNAL,
    ...
    # Ã¢â€â‚¬Ã¢â€â‚¬ mcp-minierp-finance Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    "get_vendor_details": ToolPolicy(
        backend="minierp_finance",
        intent="vendor_details",
        account_scoped=False,
        risk=READ_LOW,
        description="Shows a vendor's profile Ã¢â‚¬â€ payment terms, currency, and default payment method.",
        fields={
            "vendorCode": INTERNAL,
    ...
    "get_ap_invoice_details": ToolPolicy(
        ...
        account_scoped=False,
        risk=READ_SENSITIVE,
        description="Looks up one vendor bill Ã¢â‚¬â€ amount, due date, and whether it's been paid.",
        fields={
            "invoiceNumber": INTERNAL,
            "docType": INTERNAL,
            "invoiceDate": INTERNAL,
    ...
    "get_po_order_status": ToolPolicy(
        ...
        account_scoped=False,
        risk=READ_SENSITIVE,
        description="Shows the status of a purchase order Ã¢â‚¬â€ where it stands, vendor, and total.",
        fields={
            "orderNumber": INTERNAL,
            "orderStatus": INTERNAL,
            "orderDate": INTERNAL,
