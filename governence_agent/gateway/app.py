...
# ── Federated miniERP tools (namespaced per domain backend) ───────────────────
...
# ── Federated accounts tools (namespaced, backend "minierp_accounts") ────────
...
# ── Federated resolver tools (namespaced, backend "minierp_accounts") ─────────
...
# ── Federated quaternary tools (aggregations + reverse lookups) ───────────────
...
# ── Federated shipments tools (namespaced, backend "minierp_shipments") ──────
...
# ── Federated finance tools (namespaced, backend "minierp_finance") ──────────
...
# ── Governed chat (Stage 1: thin, session-keyed assistant) ────────────────────
...
# ── Admin CRUD API (admin-only, audited to policy_audit) ──────────────────────
...
# ── Security-monitoring analytics (admin-only, read-only over the audit ring) ──
...
# ── User self-service (own denials, own activity, in-browser tool playground) ──
